...
**Use [LANGUAGE.md](LANGUAGE.md) vocabulary for the architecture.** Name modules after the domain concepts they represent — not "the FooBarHandler," and not "the Order service."
